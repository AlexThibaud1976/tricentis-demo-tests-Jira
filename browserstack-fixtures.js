...
const test = base.test.extend({
  ...
  page: async ({ context }, use, testInfo) => {
    ...
    // Note: Les screenshots sont gérés automatiquement par Playwright
    // en mode 'only-on-failure' (voir playwright.config.browserstack.js)
    // Pas de capture manuelle pour éviter les timeouts sur BrowserStack
  },
});
